...
<!DOCTYPE html>
  <div class="wrapper_rescate">
    <div class="animsition" data-animsition-in-class="fade-in-right" data-animsition-in-duration="1000" id="seccion_edad">
    ...
    <!-- /////////////////////////////////////////////////////////////////////// -->
        ...
        <div class="chat">
          ...
          <div class="chat-message clearfix">
            <input type="number" name="message-to-send" id="message-to-send" placeholder ="Escribe tu edad" rows="3"></input>
                    
          <!--   <i class="fa fa-file-o"></i> &nbsp;&nbsp;&nbsp;
            <i class="fa fa-file-image-o"></i> -->
            
            <button>Enviar</button>
            <a href="index.php?seccion=escuela">
