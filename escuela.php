...
<!DOCTYPE html>
  <div class="wrapper_rescate">
    <div class="animsition" data-animsition-in-class="fade-in-right" data-animsition-in-duration="1000" id="seccion_escuela">
        <section id="escuela">
        ...
        <!-- /////////////////////////////////////////////////////////////////////// -->
          ...
          <div class="container clearfix" id="chat_escuela">
        ...
        <div class="chat">
            ...
            <ul>
              ...
              <!--     <span class="message-data-name"><i class="fa fa-circle online"></i> Vincent</span>
                ...
                <div class="message my-message">
                 Bienvenido "NOMBRE", y ¿cuál es la escuela de donde nos estas visitando?   
                </div>
              </li>
          ...
          <!--   <i class="fa fa-file-o"></i> &nbsp;&nbsp;&nbsp;
            ...
            <a href="index.php?seccion=grado">
